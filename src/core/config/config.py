...
# Dev-only stream selector: in APP_MODE=dev, use mock for fast UI iteration
# or live to hit the full pipeline without switching to prod mode.
# This flag is intentionally ignored in prod, where live streaming is always used.
